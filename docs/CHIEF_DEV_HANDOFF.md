...
- Aktueller HEAD: Coverage Stability C3.2 (`47cfafd`)
...
- Decisions: D-R1.1-001…004 · D-R1.2-001…003 · D-R1.3-001…004 ·
  D-VE-REWORK-001…006 · D-COVERAGE-STABILITY-001…006
...
- **C3.2 Semantic Gap Identity umgesetzt** (`47cfafd`)
  - Domainvertrag `coverage-gap-semantic-key-v1` (keine Persistenz, keine Materialize-Integration)
  - `gap_id` bleibt UUID4; Semantic Key getrennt (D-005 / D-006)
  - Kollisionsschutz + konservative Text-/Collection-Normalisierung
...
**C3.3 Match Engine** nach Chief-Dev-Freigabe.

Gesperrt: C3.4 Carry-Forward, C4, UI-Beschriftungsfix, V4, R1.4, echte Provider.
