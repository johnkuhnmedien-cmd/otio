...
def test_r1_schema14_tables_constraints_and_migration(discovery_project: Project) -> None:
    ...
    try:
        ...
        for forbidden in ("consent_events", "dramaturgy"):
    ...
    try:
        assert reg_db.read_schema_version(conn3) == v_before == "15"
        assert (
...
def test_r1_eligibility_and_ui_fail_on_media_io(
    ...
    class _FakeSt:
        ...
        def checkbox(self, *a: Any, **k: Any) -> bool:
            # Phase 8C: Consent-Checkbox ist erlaubt; Default bleibt False.
            return False

        def multiselect(self, *a: Any, **k: Any) -> list[Any]:
...
def test_r1_ui_source_has_no_provider_or_media_io() -> None:
