"""Phase 8A: Assetanalyse-UI — No-I/O, Navigation, keine Runs."""
...
class _FakeStreamlit:
    ...
    def button(self, *args: Any, **kwargs: Any) -> bool:
        raise AssertionError("UI darf keinen Startbutton anbieten")
...
def test_render_read_only_no_run(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert any("noch nicht aktiviert" in info for info in fake_st.infos)
    assert any("Phase 8B" in md for md in fake_st.markdowns)
