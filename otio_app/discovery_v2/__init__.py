"""Discovery V2 — isolierte dritte Pipeline (Grundgerüst).

Artefakte gehören ausschließlich unter ``_otio_v2/``.
Classic- und Without-VO-Code unter ``_otio/`` wird hier nicht beschrieben
und nicht beschrieben geschrieben.
"""
