...
ANALYSIS_ERROR_ANALYSIS_ASSET_FRAME_LIMIT_EXCEEDED = (
    "analysis_asset_frame_limit_exceeded"
)
ANALYSIS_ERROR_ANALYSIS_ASSET_BYTE_LIMIT_EXCEEDED = (
    "analysis_asset_byte_limit_exceeded"
)
ANALYSIS_ERROR_ANALYSIS_ASSET_HAS_NO_REPRESENTATIVE_FRAMES = (
    "analysis_asset_has_no_representative_frames"
)
ANALYSIS_ERROR_ANALYSIS_ASSET_NOT_ELIGIBLE = "analysis_asset_not_eligible"
...
ANALYSIS_MODEL_ERROR_CODES = (
    ...
    ANALYSIS_ERROR_ANALYSIS_ASSET_BYTE_LIMIT_EXCEEDED,
    ANALYSIS_ERROR_ANALYSIS_ASSET_HAS_NO_REPRESENTATIVE_FRAMES,
    ANALYSIS_ERROR_ANALYSIS_ASSET_NOT_ELIGIBLE,
