...
PROMPTS = {
    ...
    "visual_edit_plan": PROMPT_VERSION_VISUAL_EDIT_PLAN,
    "humanity_review": PROMPT_VERSION_HUMANITY_REVIEW,
    "editorial_repair_proposal": PROMPT_VERSION_EDITORIAL_REPAIR_PROPOSAL,
}
...
RESPONSE_SCHEMAS = {
    ...
    "visual_edit_plan": RESPONSE_SCHEMA_VISUAL_EDIT_PLAN,
    "humanity_review": RESPONSE_SCHEMA_HUMANITY_REVIEW,
    "editorial_repair_proposal": RESPONSE_SCHEMA_EDITORIAL_REPAIR_PROPOSAL,
}
