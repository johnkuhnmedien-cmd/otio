...
# SFX planner is Enhanced-Cut-Plan UI only (not listed in classic VO roles).
VOICEOVER_GEN_ROLE_ENHANCED_SFX_PLANNER = "enhanced_sfx_planner"
VOICEOVER_GEN_ROLES = (
    ...
    VOICEOVER_GEN_ROLE_ENHANCED_SUPPLEMENT_FUNNEL,
)
VOICEOVER_GEN_ROLE_LABELS = {
    ...
    VOICEOVER_GEN_ROLE_ENHANCED_SUPPLEMENT_FUNNEL: "Enhanced Supplement-Funnel",
    VOICEOVER_GEN_ROLE_ENHANCED_SFX_PLANNER: "Enhanced SFX Planner",
}
VOICEOVER_GEN_ENHANCED_SFX_PLANNER_DEFAULT_PROVIDER = "openai"
...
# Enhanced Cut Plan LLM 2/3: kuratierte Auswahl inkl. günstigerer Varianten.
...
ENHANCED_CUT_LLM_MODEL_LABELS: dict[str, str] = {
    ...
    "anthropic:claude-opus-5": "Claude Opus 5 — Flagship",
...
VOICEOVER_GEN_ENHANCED_FUNNEL_DEFAULT_PROVIDER = "gemini"
VOICEOVER_GEN_ENHANCED_FUNNEL_DEFAULT_MODEL = "gemini-3.5-flash"
ENHANCED_FUNNEL_LLM_MODEL_CHOICES: tuple[str, ...] = GEMINI_MODEL_CHOICES
ENHANCED_FUNNEL_LLM_MODEL_LABELS: dict[str, str] = {
    "gemini-3.1-flash-lite": "Gemini 3.1 Flash Lite — günstig (Experiment)",
    "gemini-3-flash-preview": "Gemini 3 Flash Preview — schnell",
...
# Dramaturgie-Planungsmodi (UI-Buttons in ③ Dramaturgie).
DRAMATURGY_PLANNING_MODE_GEOGRAPHY = "geography"
DRAMATURGY_PLANNING_MODE_VARIETY = "variety"
DRAMATURGY_PLANNING_MODE_SPECTACLE_FIRST = "spectacle_first"
...
DRAMATURGY_PLANNING_MODE_LABELS = {
    DRAMATURGY_PLANNING_MODE_GEOGRAPHY: "Dramaturgie nach Geographie planen",
...
CUT_PLAN_DEFAULT_FOLDER_TITLE_FADE_IN_SEC = 0.35
CUT_PLAN_DEFAULT_FOLDER_TITLE_FADE_OUT_SEC = 0.35
