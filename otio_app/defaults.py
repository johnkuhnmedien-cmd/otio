...
# Discovery V2 schreibt ausschließlich hier — nie nach DEFAULT_WORK_SUBDIR (_otio).
DEFAULT_DISCOVERY_V2_WORK_SUBDIR = "_otio_v2"
...
PROJECT_MODE_DISCOVERY_V2 = "discovery_v2"
...
PROJECT_MODE_LABELS = {
    ...
    PROJECT_MODE_DISCOVERY_V2: "Discovery V2",
}
