...
# Batch „Alle/Offene LLM Cuts“ bzw. „Python Timings“: parallele Kapitel.
# LLM bewusst begrenzt (Rate-Limits); Timing darf höher sein (lokal/CPU).
ENHANCED_CHAPTER_LLM_MAX_WORKERS = 4
