    ...
    with st.expander("Cut Plan Settings", expanded=False):
        ...
        llm_cut_prefix_count = st.number_input(
            ...
            help=(
                ...
                "Filmreihenfolge. 4 = Intro + erste drei Kapitel mit dem "
                "Prefix-Modell, der Rest mit dem Standard-Modell. 0 = aus."
            ),
        )
        ...
        llm_cut_prefix_model = st.selectbox(
            ...
            help=(
                "Leer = Prefix aus. Beispiel: N=4 und GPT-5.6 Sol → Intro und "
                "die ersten drei Kapitel mit Sol, alle weiteren mit dem "
                "Standard-Modell."
            ),
        )
    ...
    for status in statuses:
        ...
        with otio_col:
            run_otio = st.button(
                ...
                help=(
                    "Kapitel-OTIO schreiben. Zu kurze Clips, Lücken und dasselbe "
                    "Asset zweimal hintereinander werden rot markiert."
                ),
            )
    ...
    with col_otio:
        run_all_otio = st.button(
            ...
            help=(
                ...
                "Zu kurze Clips, offene Lücken und dasselbe Asset zweimal "
                "hintereinander werden rot markiert — der Export bricht "
